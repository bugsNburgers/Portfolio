  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      if (threeRef.current) {
        ...
        // Remove event listeners from the parent element
      ...
      const targetEl = container.parentElement || container;
      targetEl.addEventListener('pointerdown', onPointerDown as EventListener, {
        passive: true
      });
    ...
    return () => {
      ...
      // Clean up event listeners from the parent element
      const targetEl = container.parentElement || container;
      targetEl.removeEventListener('pointerdown', onPointerDown as EventListener);
      targetEl.removeEventListener('pointermove', onPointerMove as EventListener);
